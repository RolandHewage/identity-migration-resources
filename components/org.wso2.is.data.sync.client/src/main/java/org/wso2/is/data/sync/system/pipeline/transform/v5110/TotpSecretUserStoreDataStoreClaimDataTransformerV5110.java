...
@VersionAdvice(version = "5.11.0", tableName = "UM_USER_ATTRIBUTE")
public class TotpSecretUserStoreDataStoreClaimDataTransformerV5110 implements DataTransformer {

    private String oldEncryptionAlgorithm;

    public TotpSecretUserStoreDataStoreClaimDataTransformerV5110(String oldEncryptionAlgorithm) {
