...
public class DataSourceManager {
    ...
    public static Connection getSourceConnection(String schema) {
        ...
        try {
            dbConnection = DriverManager.getConnection("jdbc:mysql://localhost/carbon?user=root&password=root");
    ...
    public static Connection getTargetConnection(String schema) {
        ...
        Connection dbConnection = null;
        try {
            dbConnection = DriverManager.getConnection("jdbc:mysql://localhost/carbonnew?user=root&password=root");
        } catch (SQLException e) {
            e.printStackTrace();
        }
        return dbConnection;
