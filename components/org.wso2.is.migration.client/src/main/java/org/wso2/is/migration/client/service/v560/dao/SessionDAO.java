 ...
 */
package org.wso2.is.migration.client.service.v560.dao;

import org.wso2.is.migration.client.service.v560.util.SQLConstants;
...
public class SessionDAO {
    ...
    public void updateSessionExpireTime(Long cleanUpTimeOut, Connection connection) throws SQLException {
        ...
        try (PreparedStatement preparedStatement = connection.prepareStatement(SQLConstants.UPDATE_IDN_AUTH_SESSION_STORE)) {
