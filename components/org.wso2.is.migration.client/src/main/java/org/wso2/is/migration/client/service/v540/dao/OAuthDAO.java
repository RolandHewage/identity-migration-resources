...
package org.wso2.is.migration.client.service.v540.dao;

import org.wso2.is.migration.client.service.v540.bean.OAuthConsumerApp;
import org.wso2.is.migration.client.service.v540.bean.OAuth2Scope;
import org.wso2.is.migration.client.service.v540.bean.OAuth2ScopeBinding;
import org.wso2.is.migration.client.service.v540.SQLConstants;
...
public class OAuthDAO {
    ...
    public List<OAuthConsumerApp> getAllOAuthConsumerApps(Connection connection) throws SQLException {
        ...
        try (PreparedStatement preparedStatement = connection.prepareStatement(SQLConstants.RETRIEVE_ALL_CONSUMER_APPS);
    ...
    public void updateExpiryTimesDefinedForOAuthConsumerApps(Connection connection, List<OAuthConsumerApp>
        ...
        try (PreparedStatement preparedStatement = connection.prepareStatement(SQLConstants.UPDATE_EXPIRY_TIMES_IN_CONSUMER_APPS)) {
    ...
    public List<OAuth2Scope> getAllOAuth2Scopes(Connection connection) throws SQLException {
        ...
        try (PreparedStatement preparedStatement = connection.prepareStatement(SQLConstants.GET_ALL_OAUTH2_SCOPES);
             ResultSet resultSet = preparedStatement.executeQuery()) {
            while (resultSet.next()) {
    ...
    public void addOAuth2ScopeBindings(Connection connection, List<OAuth2ScopeBinding> oAuth2ScopeBindings)
        ...
        try (PreparedStatement preparedStatement = connection.prepareStatement(SQLConstants.ADD_SCOPE_BINDINGS)) {
    ...
    public void updateOAuth2Scopes(Connection connection, List<OAuth2Scope> updatedOAuth2Scopes) throws SQLException {
        ...
        try (PreparedStatement preparedStatement = connection.prepareStatement(SQLConstants.UPDATE_OAUTH2_SCOPES)) {
