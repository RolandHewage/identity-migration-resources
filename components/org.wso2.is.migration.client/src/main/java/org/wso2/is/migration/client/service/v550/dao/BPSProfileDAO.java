...
import org.wso2.is.migration.client.service.v550.bean.BPSProfile;
...
public class BPSProfileDAO {
    ...
    public List<BPSProfile> getAllProfiles(Connection connection) throws SQLException {
        ...
        try (PreparedStatement preparedStatement = connection.prepareStatement(SQLConstants.RETRIEVE_ALL_BPS_PROFILES);
    ...
    public void updateNewPasswords(List<BPSProfile> updatedBpsProfileList, Connection connection) throws SQLException {
        ...
        try (PreparedStatement preparedStatement = connection.prepareStatement(SQLConstants.UPDATE_BPS_PROFILE_PASSWORD)) {
