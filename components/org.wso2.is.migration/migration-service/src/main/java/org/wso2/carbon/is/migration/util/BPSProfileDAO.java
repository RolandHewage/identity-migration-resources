...
import static org.wso2.carbon.is.migration.util.SQLConstants.RETRIEVE_ALL_BPS_PROFILES;
import static org.wso2.carbon.is.migration.util.SQLConstants.UPDATE_BPS_PROFILE_PASSWORD;
...
public class BPSProfileDAO {
    ...
    private static BPSProfileDAO
            instance = new BPSProfileDAO();
