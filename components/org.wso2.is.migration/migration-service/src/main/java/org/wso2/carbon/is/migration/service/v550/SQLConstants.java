...
public class SQLConstants {
    ...
    public static final String RETRIEVE_ALL_TOKENS_WITH_HASHES_MYSQL =
            "SELECT ACCESS_TOKEN, REFRESH_TOKEN, TOKEN_ID, " +
            "ACCESS_TOKEN_HASH, REFRESH_TOKEN_HASH FROM IDN_OAUTH2_ACCESS_TOKEN OFFSET ? LIMIT ?";

    public static final String RETRIEVE_ALL_TOKENS_WITH_HASHES_OTHER =
            "SELECT ACCESS_TOKEN, REFRESH_TOKEN, TOKEN_ID, " +
    ...
    public static final String RETRIEVE_ALL_AUTHORIZATION_CODES_WITH_HASHES_MYSQL =
            "SELECT AUTHORIZATION_CODE, CODE_ID, " +
            "AUTHORIZATION_CODE_HASH FROM IDN_OAUTH2_AUTHORIZATION_CODE OFFSET ? LIMIT ?";

    public static final String RETRIEVE_ALL_AUTHORIZATION_CODES_WITH_HASHES_OTHER =
            "SELECT AUTHORIZATION_CODE, CODE_ID, " +
