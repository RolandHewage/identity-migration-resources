...
import org.wso2.carbon.is.migration.service.v5100.V5100Migration;
import org.wso2.carbon.is.migration.service.v5110.V5110Migration;
import org.wso2.carbon.is.migration.service.v600.V600Migration;
...
import org.wso2.carbon.is.migration.service.v590.V590Migration;
import org.wso2.carbon.is.migration.service.v610.V610Migration;
...
public class VersionMigrationHolder {
    ...
    private VersionMigrationHolder() {
        ...
        versionMigrationList.add(new V590Migration());
        versionMigrationList.add(new V5100Migration());
        versionMigrationList.add(new V5110Migration());
        versionMigrationList.add(new V600Migration());
        versionMigrationList.add(new V610Migration());
    }
