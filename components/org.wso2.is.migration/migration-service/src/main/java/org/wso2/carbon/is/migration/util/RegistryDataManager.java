...
public class RegistryDataManager {
    ...
    private static RegistryDataManager
            instance = new RegistryDataManager();
    ...
    private void migrateKeyStorePasswordForTenant(int tenantId) throws RegistryException, MigrationClientException {
    ...
    private void migrateSubscriberDataForTenant(int tenantId) throws RegistryException, MigrationClientException {
    ...
    private void migrateSysLogPropertyPasswordForTenant(int tenantId) throws RegistryException,
    ...
    private void updateSecurityPolicyPassword(int tenantId) throws RegistryException,
            XMLStreamException, MigrationClientException {
                            ...
                            while (propertySet.hasNext()) {
                                ...
                                if (SERVICE_PRINCIPAL_PASSWORD.equals(kbProperty.getAttributeValue(new QName(NAME)))) {
                                    ...
                                    newEncryptedPassword =
                                            EncryptionUtil.transformToSymmetric(encryptedPassword);
    ...
    private void updateRegistryProperties(Registry registry, String resource, List<String> properties)
            throws RegistryException, MigrationClientException {
        ...
        if (registry.resourceExists(resource)) {
            try {
                ...
                for (String encryptedPropertyName : properties) {
                    ...
                    String newValue = EncryptionUtil.transformToSymmetric(oldValue);
