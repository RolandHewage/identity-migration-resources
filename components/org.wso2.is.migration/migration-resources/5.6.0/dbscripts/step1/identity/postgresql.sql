...
DROP INDEX IF EXISTS IDX_IDN_SCIM_GROUP_TI_RN;
DROP INDEX IF EXISTS IDX_IDN_SCIM_GROUP_TI_RN_AN;
DROP INDEX IF EXISTS IDX_IDN_AUTH_SESSION_TIME;
DROP INDEX IF EXISTS IDX_IDN_AUTH_TMP_SESSION_TIME;
