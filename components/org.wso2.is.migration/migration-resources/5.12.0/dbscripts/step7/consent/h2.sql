...
ALTER TABLE CM_SP_PURPOSE_PII_CAT_ASSOC ADD ID INTEGER NOT NULL AUTO_INCREMENT;
ALTER TABLE CM_SP_PURPOSE_PII_CAT_ASSOC ADD PRIMARY KEY(ID);

ALTER TABLE CM_CONSENT_RECEIPT_PROPERTY ADD ID INTEGER NOT NULL AUTO_INCREMENT;
ALTER TABLE CM_CONSENT_RECEIPT_PROPERTY ADD PRIMARY KEY(ID);
