...
ALTER TABLE IDN_OAUTH2_ACCESS_TOKEN
    ...
    MODIFY (IDP_ID DEFAULT -1 NOT NULL)
/

ALTER TABLE IDN_OAUTH2_ACCESS_TOKEN_AUDIT MODIFY (IDP_ID DEFAULT -1 NOT NULL)
/

ALTER TABLE IDN_OAUTH2_AUTHORIZATION_CODE MODIFY (IDP_ID DEFAULT -1 NOT NULL)
/
