...
ALTER TABLE IDN_OAUTH2_SCOPE_BINDING ADD BINDING_TYPE VARCHAR(255) DEFAULT 'DEFAULT'
/
...
ALTER TABLE IDN_OAUTH2_SCOPE ADD SCOPE_TYPE VARCHAR(255) DEFAULT 'OAUTH2' NOT NULL
/

ALTER TABLE IDN_OAUTH2_SCOPE ADD CONSTRAINT IDN_OAUTH2_SCOPE_UNIQUE UNIQUE (NAME, SCOPE_TYPE, TENANT_ID)
/
